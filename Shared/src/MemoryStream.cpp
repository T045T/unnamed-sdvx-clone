...
MemoryStreamBase::MemoryStreamBase(Buffer& buffer, bool isReading)
	: BinaryStream(isReading), m_buffer(&buffer)
{}
...
MemoryWriter::MemoryWriter(Buffer& buffer)
	: MemoryStreamBase(buffer, false)
{}
